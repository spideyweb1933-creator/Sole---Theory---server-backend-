...
const allowedOrigins = [
  'https://soletheory.fit',                     // root domain
  'https://www.soletheory.fit',                 // www
  'https://sole-theory-store.vercel.app',       // store (Vercel)  <-- change if your store URL is different
  'https://sole-theory-admin-ui.vercel.app'     // admin (Vercel)  <-- change if different
];
